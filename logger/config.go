...
type Config struct {
	...
	// LogError enables logging of errors returned by handlers with stack traces.
	LogError bool
	...
	// Examples: "X-Trace-ID", "X-Request-ID"
	// Empty string means use OpenTelemetry (existing behavior).
	...
	// Return true to skip logging for the request.
